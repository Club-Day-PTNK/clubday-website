import years2021Styles from "../../styles/about/Years-2021.module.scss";
import Hero from "../../components/about/Hero";
import aboutStyles from "../../styles/About.module.scss";
import Image from "next/image";
import { memberContents } from "../../libs/about/members2021";
...
const year2021 = () => {
  ...
  return (
    <div className={years2021Styles.container}>
      <div className={aboutStyles.container}>
        <Hero />
      </div>
      <div className={years2021Styles.body}>
        <div className={years2021Styles.yearsContainer}>
          <FontAwesomeIcon
            icon={faTimes}
            className={years2021Styles.icon}
            onClick={() => {}}
          />
          <div className={years2021Styles.imageWrapper}>
            <Image
          ...
          <h1 className={years2021Styles.title}>CLUB DAY 2021</h1>
          <h3 className={years2021Styles.subtitle}>Infinity</h3>
          <p className={years2021Styles.para}>
          ...
          <div className={years2021Styles.memberContainer}>
            {deque.toArray().map((element) => (
              <div
                className={years2021Styles.team}
                key={element.id}
                onClick={(_) => {
                  tabClick(element.id);
                }}
            ...
            <div className={years2021Styles.teamBodyContainer}>
